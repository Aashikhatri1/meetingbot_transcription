...
def create_browser_instance1():
    ...
    #driver = webdriver.Chrome(executable_path=r'C:\Users\Administrator\Downloads\chromedriver_win32', options=chrome_options)
    #driver = webdriver.Chrome(service=Service(ChromeDriverManager(version="120.0.6099.109").install()), options=chrome_options)
    #driver = webdriver.Chrome(service=Service(ChromeDriverManager().install()), options=chrome_options)
    #path_to_chromedriver = r'C:\Users\Administrator\Downloads\chromedriver_win32\chromedriver.exe' # Update this to your path
    #driver = webdriver.Chrome(executable_path=path_to_chromedriver, options=chrome_options)
    # Path to your chromedriver
    #path_to_chromedriver = r'C:\Users\Administrator\Downloads\chromedriver_win32\chromedriver.exe'
