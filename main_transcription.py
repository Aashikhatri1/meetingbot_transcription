...
def check_new_submissions():
    ...
    try:
        ...
        Zoom_meeting_link = Meeting_automation['user_data']
                        ...
                        if doc['status'] == 'submitted':
                            ...
                            if result.modified_count > 0:
                                ...
                                if recorder_process.returncode == 0:
                                    ...
                                    #filenames3 = 'MeetingBot_' + str(doc['request_id']) + '.wav'
                                    #recorded_file_path = 'https://salescrm247.s3.amazonaws.com/' +  filenames3

                                    
                                    #s3 = boto3.client('s3')
                                    
                                    #s3.upload_file(r'C:\Users\Administrator\Documents\GitHub\meetingBot\recording.wav', 'salescrm247', filenames3 )
                                    ...
                                    #result = Zoom_meeting_link.update_one({'request_id': doc['request_id']}, {"$set": {"recordedFile": recorded_file_path}})
                                    #if result.modified_count > 0:
...
#set AWS_ACCESS_KEY_ID=AKIAVSYBEZQGJVFUUK6A
#set AWS_SECRET_ACCESS_KEY=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
